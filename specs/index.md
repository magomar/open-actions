...
| [005](005_antigravity_usage.md) | Antigravity Usage | Feature Spec | `approved` | A device action that surfaces Google Antigravity model quota and credit telemetry on a button. |
