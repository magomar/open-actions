...
| **Hue Control** | [`actions/hue-control/`](actions/hue-control/) | Control Philips Hue lights and rooms over the Bridge local API: on/off, color, color cycle, brightness, temperature, and scenes. |
